...
def post_install():
    ...
    check_call('cd /tmp && wget https://github.com/jcupitt/libvips/releases/download/v8.5.7/vips-8.5.7.tar.gz && tar xvf vips-8.5.7.tar.gz && cd vips-8.5.7 && ./configure && make install', shell=True)
